...
class RomBase:
    ...
    #: fact here is: a reader holding the base holds the whole cartridge,
    #: rather than being handed the base and the size separately, which is a
    #: pair a caller can get half right. :func:`~features.applied` is what
    #: sets it.
