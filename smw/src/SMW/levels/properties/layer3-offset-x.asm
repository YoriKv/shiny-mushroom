; Where the level's Layer 3 starts across, one signed byte per level in
; 16x16 tiles: an offset from Layer 1's position for a setting that follows
; it, and the position outright for one that does not. $00 is a level that
; says nothing. Only assembled under !Define_SMW_Layer3Settings, into the
; level bank.
OffsetX:
