; Lunar Magic's seventh secondary-header byte, one per level, OFYYYYYY: O
; the background is placed relative to the foreground alone, F the
; foreground and background offset's high bit, YYYYYY the second
; entrance-position method's high Y bits. The load's placement reads all
; three (Config/LunarMagicLevels.asm). Only assembled under
