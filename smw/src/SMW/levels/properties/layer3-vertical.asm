; The level's Layer 3 vertical settings, one per level, S--vvvvv: S Layer 3
; drawn on the subscreen rather than the main one, vvvvv the vertical scroll
; setting. $00 is a level that says nothing. Only assembled under
