; Where the level's Layer 3 starts down the screen, one signed byte per
; level in 16x16 tiles -- an offset from Layer 1's position, or the position
; outright, as the vertical setting decides. $00 is a level that says
; nothing. Only assembled under !Define_SMW_Layer3Settings, into the level
; bank.
OffsetY:
