...
; Default values for $1656, various interaction-related flags, for the
; standard sprites. $07F27B: Goomba 1656 value - change from 10 to 30 to
; make Goombas die when jumped on like the classic Goombas in SMB or SMB3.
; $07F27C: Winged Goomba 1656 value - change from 10 to 30 to make Winged
; Goombas "die when jumped on" (when jumped on, they will "die" and spawn a
; regular Goomba, just like the Paragoombas in SMB3). $07F306: Sumo Bros.
; 1656 value (object clipping/table offset, can be jumped on, dies when
; jumped on, hop in/kick shells, disappear in a cloud of smoke).
Sprite1656Vals:
...
; Default values for $1662, some death-related flags and the sprite
; clipping, for the standard sprites.
Sprite1662Vals:
...
; Default values for $166E, various flags to disable some stuff (like
; fireball death and layer 2 interaction) and palette/graphics page, for the
; standard sprites.
Sprite166EVals:
...
; Change $07F57D from 00 to 01 to fix the glitched tiles that appear when a
; reflecting fireball goes into lava and make it display the normal lava
; splash.
Sprite167AVals:
...
; Default values for $1686, various misc flags, for the standard sprites.
Sprite1686Vals:
...
; Default values for $190F, various misc flags, for the standard sprites.
; Change $07F69C from 05 to 25 to fix the Dolphin tails showing up when
; they're vertically off-screen.
Sprite190FVals:
