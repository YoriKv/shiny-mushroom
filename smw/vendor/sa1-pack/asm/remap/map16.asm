...
ORG $0582D9
	dl $40D000
; A base whose translevel-remap feature is on (Define_SMW_TranslevelRemap)
; has a JML where this read was -- its own lookup already reads $40D000 --
; and this write would land inside the JML's operand.
